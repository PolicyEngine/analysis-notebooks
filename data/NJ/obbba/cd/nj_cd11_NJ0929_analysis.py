...
DATASET = "hf://policyengine/test/NJ_0929.h5"

print("=" * 60)
print("USING DATASET: NJ_0929.h5")
print("=" * 60)
...
# Display results
print("\n=== Winners and Losers by Income Decile (NJ CD11 - NJ_0929.h5) ===")
print(summary_df.to_string())

# Save to CSV with clear filename
output_file = '/Users/daphnehansell/Documents/GitHub/analysis-notebooks/us/medicaid/nj_cd11_NJ0929_winners_losers_by_decile.csv'
summary_df.to_csv(output_file, index=False)
print(f"\nResults saved to: {output_file}")

# Save detailed household results for verification
detailed_file = '/Users/daphnehansell/Documents/GitHub/analysis-notebooks/us/medicaid/nj_cd11_NJ0929_winners_losers_detailed.csv'
results.to_csv(detailed_file, index=False)
print(f"Detailed results saved to: {detailed_file}")

# Print summary statistics
print("\n=== Overall Summary (NJ_0929.h5 DATASET) ===")
total_weight = results['weight'].sum()
print(f"Dataset: NJ_0929.h5")
...
output_chart = '/Users/daphnehansell/Documents/GitHub/analysis-notebooks/us/medicaid/nj_cd11_NJ0929_winners_losers_chart.png'
plt.savefig(output_chart, dpi=150, bbox_inches='tight', facecolor='white', edgecolor='none')
print(f"Chart saved to: {output_chart}")

print("\n=== Analysis Complete ===")
print("NJ_0929.h5 dataset analysis complete.")
print(f"Compare files ending in '_NJ0929_' with previous results.")